...
<head>
    ...
    <title>Register Admin Patriots</title>
            ...
            <div class="card-body p-0">
                ...
                <div class="row ml-5">
                    <div class="col-lg-6">
                        <div class="p-5">
                            <div class="">
                                <h1 class="h2 text-gray-900 mt-2 mb-4">Selamat Datang!</h1>
                            </div>
                            <h6 class="text-gray-900 small mt-5 mb-4 ml-1">Sudah Punya Akun?
                                <a class="text-warning" href="login">Login</a> 
                            </h6>
                            <form action="{{ route('register') }}" method="POST" class="">
                                @csrf
                                <div class="form-group">
                                    <h6 class="text-gray-900 ml-1">Nama Lengkap</h6>
                                    <input type="name" name="name" class="form-control form-control-user @error('name') is-invalid @enderror"
                                ...
                                <div class="form-group">
                                 ...
                                 <div class="form-group">
                                    <h6 class="text-gray-900 ml-1">Konfirmasi Password</h6>
                    ...
                    <div class="col-lg-6 d-none p-5 mt-5 d-lg-block">
